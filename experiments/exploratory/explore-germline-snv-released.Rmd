...
files <- (Sys.glob("/Users/jineta/git/gitrepo/biobank-release-2/data/raw_data/germline_snv_batch1_2_3/*.maf"))

listOfFiles_mpnst <- lapply(files, function(x) maftools::read.maf(maf = x,
                                                            clinicalData = mpnst_clindata))
listOfFiles_pnf <- lapply(files, function(x) maftools::read.maf(maf = x,
...
![Figure 1](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Somatic_all_samples_unfiltered_summary.png "figure 1")
...
# pdf("/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Somatic_all_samples_unfiltered_GOI.pdf", height = 40, width = 40)
...
![Figure 2](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Somatic_all_samples_unfiltered_GOI.png "shows an oncoplot of all unfiltered variants identified in our list of genes of interest.") 
