...
```{r get-data, eval=FALSE, echo=FALSE, results='hide', message=FALSE, warning=FALSE, include=FALSE}
...
## Visualize an oncoplot of all samples available
...
## Subset the samples to select PNF and MPNST samples
...
## Visualize oncoplots of PNF and MPNST samples
