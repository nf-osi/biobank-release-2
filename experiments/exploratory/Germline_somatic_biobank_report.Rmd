...
DT::datatable(jhu_triplicates_clinicaldata[, c("individualID", "tumorType", "SequencingBatch")] %>% unique() %>% arrange(individualID) %>% dplyr::filter(!is.nan(tumorType)))
...
![Figure 3](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Germline_pnf_mpnst_passfiltered_GOI.png "shows filtered variants in our list of genes of interest.")
...
In the plots below we note that germline data from only 4 PNF samples are represented. We are currently investigating the missing sample.

Figure 4 below shows filtered germline and de-novo variants in top 100 genes in the triad samples.

![Figure 4](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Germline_triad_pnf_mpnst_passfiltered_top.png "shows the filtered variants in top 100 mutated genes in PNF and MPNST tumors in triads. samples.") 

&nbsp;

Figure 5 below shows filtered variants in the triads in our list of genes of interest.

![Figure 5](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Germline_triad_pnf_mpnst_passfiltered_GOI.png "shows filtered variants in our list of genes of interest in the triads.")
...
![Figure 7](/Users/jineta/git/gitrepo/biobank-release-2/experiments/figures/Somatic_all_samples_unfiltered_GOI.png "shows an oncoplot of all unfiltered variants identified in our list of genes of interest.") 
